...
/**
 * @ORM\Entity(repositoryClass=DegatCycloniqueRepository::class)
 */
class DegatCyclonique
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="degatCyclonique")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setDegatCyclonique($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getDegatCyclonique() === $this) {
                $cultureMere->setDegatCyclonique(null);
            }
        }
