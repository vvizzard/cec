...
/**
 * @ORM\Entity(repositoryClass=ModeRepiquageRepository::class)
 */
class ModeRepiquage
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="modeRepiquage")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setModeRepiquage($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getModeRepiquage() === $this) {
                $cultureMere->setModeRepiquage(null);
            }
        }
