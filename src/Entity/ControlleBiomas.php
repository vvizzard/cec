...
/**
 * @ORM\Entity(repositoryClass=ControlleBiomasRepository::class)
 */
class ControlleBiomas
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="controlleBiomas")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setControlleBiomas($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getControlleBiomas() === $this) {
                $cultureMere->setControlleBiomas(null);
            }
        }
