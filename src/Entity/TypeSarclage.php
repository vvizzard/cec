...
/**
 * @ORM\Entity(repositoryClass=TypeSarclageRepository::class)
 */
class TypeSarclage
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="typeSarclage")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setTypeSarclage($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getTypeSarclage() === $this) {
                $cultureMere->setTypeSarclage(null);
            }
        }
