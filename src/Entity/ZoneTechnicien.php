...
/**
 * @ORM\Entity(repositoryClass=ZoneTechnicienRepository::class)
 */
class ZoneTechnicien
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="zoneTechnicien")
     */
    ...
    public function addAgriculteur(Agriculteur $agriculteur): self
    {
        if (!$this->agriculteurs->contains($agriculteur)) {
            ...
            $agriculteur->setZoneTechnicien($this);
        }
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getZoneTechnicien() === $this) {
                $agriculteur->setZoneTechnicien(null);
            }
        }
