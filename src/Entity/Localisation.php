...
class Localisation
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Parcelle::class, mappedBy="localisation")
     */
    private $parcelles;
    ...
    public function removeParcelle(Parcelle $parcelle): self
    {
        if ($this->parcelles->contains($parcelle)) {
            ...
            if ($parcelle->getLocalisation() === $this) {
                $parcelle->setLocalisation(null);
            }
        }
