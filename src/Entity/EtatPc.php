...
/**
 * @ORM\Entity(repositoryClass=EtatPcRepository::class)
 */
class EtatPc
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="etatPc")
     */
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getEtatPc() === $this) {
                $cultureMere->setEtatPc(null);
            }
        }
