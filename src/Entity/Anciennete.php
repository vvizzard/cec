...
/**
 * @ORM\Entity(repositoryClass=AncienneteRepository::class)
 */
class Anciennete
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Parcelle::class, mappedBy="anciennete")
     */
    private $parcelles;
    ...
    public function removeParcelle(Parcelle $parcelle): self
    {
        if ($this->parcelles->contains($parcelle)) {
            ...
            if ($parcelle->getAnciennete() === $this) {
                $parcelle->setAnciennete(null);
            }
        }
