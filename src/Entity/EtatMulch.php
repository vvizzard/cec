...
/**
 * @ORM\Entity(repositoryClass=EtatMulchRepository::class)
 */
class EtatMulch
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="etatMulch")
     */
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getEtatMulch() === $this) {
                $cultureMere->setEtatMulch(null);
            }
        }
