...
/**
 * @ORM\Entity(repositoryClass=BvpiRepository::class)
 */
class Bvpi
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="bvpi")
     */
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getBvpi() === $this) {
                $agriculteur->setBvpi(null);
            }
        }
