...
/**
 * @ORM\Entity(repositoryClass=TypeElevageRepository::class)
 */
class TypeElevage
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="typeElevage")
     */
    ...
    public function addAgriculteur(Agriculteur $agriculteur): self
    {
        if (!$this->agriculteurs->contains($agriculteur)) {
            ...
            $agriculteur->setTypeElevage($this);
        }
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getTypeElevage() === $this) {
                $agriculteur->setTypeElevage(null);
            }
        }
