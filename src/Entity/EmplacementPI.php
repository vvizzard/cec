...
/**
 * @ORM\Entity(repositoryClass=EmplacementPIRepository::class)
 */
class EmplacementPI
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Parcelle::class, mappedBy="emplacementPI")
     */
    private $parcelles;
    ...
    public function addParcelle(Parcelle $parcelle): self
    {
        if (!$this->parcelles->contains($parcelle)) {
            ...
            $parcelle->setEmplacementPI($this);
        }
    ...
    public function removeParcelle(Parcelle $parcelle): self
    {
        if ($this->parcelles->contains($parcelle)) {
            ...
            if ($parcelle->getEmplacementPI() === $this) {
                $parcelle->setEmplacementPI(null);
            }
        }
