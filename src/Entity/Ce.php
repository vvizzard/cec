...
/**
 * @ORM\Entity(repositoryClass=CeRepository::class)
 */
class Ce
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="ce")
     */
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getCe() === $this) {
                $agriculteur->setCe(null);
            }
        }
