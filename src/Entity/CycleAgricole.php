...
/**
 * @ORM\Entity(repositoryClass=CycleAgricoleRepository::class)
 */
class CycleAgricole
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="cycleAgricole")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setCycleAgricole($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getCycleAgricole() === $this) {
                $cultureMere->setCycleAgricole(null);
            }
        }
