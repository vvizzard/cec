...
/**
 * @ORM\Entity(repositoryClass=TypePepiniereRepository::class)
 */
class TypePepiniere
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="typePepiniere")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setTypePepiniere($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getTypePepiniere() === $this) {
                $cultureMere->setTypePepiniere(null);
            }
        }
