...
class Typologie extends Base
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="typologie")
     */
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getTypologie() === $this) {
                $agriculteur->setTypologie(null);
            }
        }
