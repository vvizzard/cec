...
/**
 * @ORM\Entity(repositoryClass=ModeInstallationRepository::class)
 */
class ModeInstallation
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity=CultureMere::class, mappedBy="modeInstallation")
     */
    ...
    public function addCultureMere(CultureMere $cultureMere): self
    {
        if (!$this->cultureMeres->contains($cultureMere)) {
            ...
            $cultureMere->setModeInstallation($this);
        }
    ...
    public function removeCultureMere(CultureMere $cultureMere): self
    {
        if ($this->cultureMeres->contains($cultureMere)) {
            ...
            if ($cultureMere->getModeInstallation() === $this) {
                $cultureMere->setModeInstallation(null);
            }
        }
