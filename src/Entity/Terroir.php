...
/**
 * @ORM\Entity(repositoryClass=TerroirRepository::class)
 */
class Terroir
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Agriculteur::class, mappedBy="terroir")
     */
    ...
    public function removeAgriculteur(Agriculteur $agriculteur): self
    {
        if ($this->agriculteurs->contains($agriculteur)) {
            ...
            if ($agriculteur->getTerroir() === $this) {
                $agriculteur->setTerroir(null);
            }
        }
