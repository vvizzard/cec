 ...
 */
final class Version20201001060817 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE culture_mere CHANGE mo_preparation_sol mo_preparation_sol SMALLINT DEFAULT NULL, CHANGE mo_installation_culture mo_installation_culture SMALLINT DEFAULT NULL, CHANGE mo_entretien1 mo_entretien1 INT DEFAULT NULL, CHANGE mo_entretien2 mo_entretien2 INT DEFAULT NULL, CHANGE mo_entretien3 mo_entretien3 INT DEFAULT NULL, CHANGE mo_recolte mo_recolte INT DEFAULT NULL, CHANGE mo_ext_preparation_sol mo_ext_preparation_sol INT DEFAULT NULL, CHANGE mo_ext_installation_culture mo_ext_installation_culture INT DEFAULT NULL, CHANGE mo_ext_entretien1 mo_ext_entretien1 INT DEFAULT NULL, CHANGE mo_ext_entretien2 mo_ext_entretien2 INT DEFAULT NULL, CHANGE mo_ext_entretien3 mo_ext_entretien3 INT DEFAULT NULL, CHANGE mo_ext_recolte mo_ext_recolte INT DEFAULT NULL');
    }
}
